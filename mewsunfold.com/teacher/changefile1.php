...
<html lang="en">
<head>
    <title>Teacher Update Notes File</title>
...
<?php include_once('includes/sidebar.php');?>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="notestitle" name="notestitle" value="<?php  echo htmlentities($row->NotesTitle);?>" readonly='true'>
                                     <!-- Edit button -->
                                    <button type="button" id="editBtn" class="btn btn-secondary mt-2" onclick="enableEdit()">Edit</button>
                                </div>
    ...
    <!-- Custom JavaScript to enable/disable edit mode -->
    <script>
        function enableEdit() {
            ...
            if (notesTitle.hasAttribute("readonly")) {
                notesTitle.removeAttribute("readonly");  // Enable edit
                notesTitle.focus();  // Set focus on the input field
                editBtn.innerText = "Save";  // Change button text to Save
                editBtn.classList.remove("btn-secondary");
                editBtn.classList.add("btn-success");
            } else {
                notesTitle.setAttribute("readonly", true);  // Disable edit
