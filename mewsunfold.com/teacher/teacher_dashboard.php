            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <?php
$teacherid = $_SESSION['ocasuid'];
$sql = "SELECT * from tbluser where ID=:teacherid";
                        ...
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Total Uploaded Subject Notes</p>
                                 <?php 
                                 $teacherid = $_SESSION['ocasuid'];
$sql1 = "SELECT * from tblnotes where UserID=:teacherid";
$query1 = $dbh->prepare($sql1);
$query1->bindParam(':teacherid', $teacherid, PDO::PARAM_STR);
$query1->execute();
$totnotes = $query1->rowCount();
?>
                                <h4 style="color: blue"><?php echo htmlentities($totnotes);?></h4>
                                        <a href="../notes.php"><h5>View Uploaded Notes</h5></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-file fa-6x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Manage Uploaded Notes Files</p>
                                 <?php 
$sql1 = "SELECT 
...
from tblnotes where UserID=:teacherid";
$query1 = $dbh->prepare($sql1);
$query1->bindParam(':teacherid', $teacherid, PDO::PARAM_STR);
$query1->execute();
