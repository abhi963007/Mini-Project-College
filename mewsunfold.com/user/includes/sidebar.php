    ...
    <div class="navbar-nav w-100">
      ...
      <div class="nav-item dropdown">
        ...
        <div class="dropdown-menu bg-transparent border-0">
          ...
          <a href="../user/student_send_message.php" class="dropdown-item">Ask Doubts</a>
          <a href="../user/student_view_messages.php" class="dropdown-item">Arrived Message</a>
